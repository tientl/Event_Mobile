                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    RichText(
                      ...
                      TextSpan(
                          text: controller.user?.fullName =='' ?'Admin' :  controller.user?.fullName ,
                          style: Theme.of(context)
                              .textTheme
                              .headline4
                              ?.copyWith(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            RichText(
                                text: TextSpan(children: <TextSpan>[
                              TextSpan(
                                  text: '${controller.event.value?.registrations?.length ?? 0}',
                                  style: TextStyle(
                                      fontSize: 28.sp,
                                      color: Colors.white,
                         ...
                         Container(
                          ...
                          child: Column(
                            ...
                            RichText(
                                text: TextSpan(children: <TextSpan>[
                              TextSpan(
                                  text: '${controller.event.value?.totalUnCheckIn}',
                                  style: TextStyle(
                                      fontSize: 28.sp,
                                      color: Colors.white,
                                      fontWeight: FontWeight.w500)),
                     ...
                     Text('Danh sách khách mời', style: Theme.of(context).textTheme.bodyText1,),
                     SizedBox(height: 20.h,),
